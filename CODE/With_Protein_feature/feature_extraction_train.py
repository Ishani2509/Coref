...
f1 = open('Final_feature_file.txt','w')
	...
	for line in content.split("\n"):
		if(line!=""):
			try:
				...
				isprotein = first.split(",")[0].split(":")[6]
				isfilter = first.split(",")[0].split(":")[7]
				mention_type = first.split(",")[0].split(":")[5]
				label = second.split("::")[1]
				f1.write(file[:-1]+','+mention+','+cand+','+mention_type+','+score+','+isthreshold+','+istopscore+','+isfilter+','+isprotein+'::'+label+'\n')
			except:
				pass
